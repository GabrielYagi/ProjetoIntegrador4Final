	...
	<section class="page-section recent-game-page spad">
		<div class="container">
			<div class="row" style="margin-top:-5%">
				...
				<?php if(@$_SESSION['usuarioID'] == null){ ?> <h2>Ligas</h2><?php } else{?> <h2>Minhas Ligas</h2> <?php } ?>
					...
					<div class="row">
                    	...
                    	<?php
							...
							$query= mysqli_query($con,"select * from ligas order by nome asc");
							...
							<div class="col-md-6">
								<div class="recent-game-item">
									...
									<div class="rgi-content" >
										<h5><?= $campo['nome']?></h5>
										<p><?= $campo['descricao']?></p>
										<a href="#" class="comment"><b>Detalhes da Liga</b></a>
						...
						<?php
							...
							$query= mysqli_query($con,"select * from ligas where id_criador='$id' order by nome asc");
							while($campo= mysqli_fetch_array($query)){?>
							...
							<div class="col-md-6">
								<div class="recent-game-item">
									...
									<div class="rgi-content" >
										<h5><?= $campo['nome']?></h5>
										<p><?= $campo['descricao']?></p>
										<a href="#" class="comment"><b>Adicionar Times</b></a>
